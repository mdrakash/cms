...
<li class="treeview {{ ($prefix == '/setups')?'active':'' }}">
          ...
          <ul class="treeview-menu">
        <li><a href="{{ route('student.class.view') }}"><i class="ti-more"></i>Student Batch</a></li>
        ...
        <li><a href="{{ route('fee.amount.view') }}"><i class="ti-more"></i>Fee Category Amount</a></li>
         ...
         <li><a href="{{ route('school.subject.view') }}"><i class="ti-more"></i>Subject</a></li>
